...
@interface SYDaiPaiSheViewController ()<UITableViewDelegate, UITableViewDataSource>
{
    NSInteger _count;
}
...
@implementation SYDaiPaiSheViewController
...
- (void)tableView:(UITableView *)tableView didSelectRowAtIndexPath:(NSIndexPath *)indexPath{
    ...
    SYYunPaiShiHaveCreatOrderInfosViewController *infos = [[SYYunPaiShiHaveCreatOrderInfosViewController alloc] initWithOrderid:model.orderid OrderState:OrderStateDaiPaiShe OrderModel:model];
