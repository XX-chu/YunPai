...
@interface SYYuYueIngViewController ()<UITableViewDelegate, UITableViewDataSource>
{
    NSInteger _count;
}
...
@implementation SYYuYueIngViewController
...
- (void)tableView:(UITableView *)tableView didSelectRowAtIndexPath:(NSIndexPath *)indexPath{
    ...
    SYYunPaiShiHaveCreatOrderInfosViewController *infos = [[SYYunPaiShiHaveCreatOrderInfosViewController alloc] initWithOrderid:model.orderid OrderState:OrderStateYuYueZhong OrderModel:model];
...
- (UIView *)tableView:(UITableView *)tableView viewForFooterInSection:(NSInteger)section{
    ...
    btn.tag = section;
    [btn addTarget:self action:@selector(reciveYuYue:) forControlEvents:UIControlEventTouchUpInside];
    return view;
}

- (void)reciveYuYue:(UIButton *)sender{
    [SVProgressHUD show];
