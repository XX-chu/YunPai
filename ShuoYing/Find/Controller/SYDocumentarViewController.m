...
#import "SYDocumentarViewController.h"
#import "SYCloudModel.h"
#import "SYCloudTableViewCell.h"
#import "SYGrapherInfosViewController.h"
#import "SYNoNetworkView.h"
@interface SYDocumentarViewController ()<UITableViewDelegate, UITableViewDataSource>
{
    NSString *_keywords;
}
...
@implementation SYDocumentarViewController
...
- (void)searchDataWith:(NSString *)text{
    ...
    NSDictionary *param = @{@"type":@6, @"page":@1, @"keywords":text};
...
- (void)searchMoreDataWith:(NSString *)text{
    self.searchPage++;
    NSString *url = [NSString stringWithFormat:@"%@%@",BaseUrl,@"/get/index.html"];
    NSDictionary *param = @{@"type":@6, @"page":[NSNumber numberWithInteger:self.searchPage], @"keywords":_keywords};
    [[SYHttpRequest sharedInstance] getDataWithUrl:url Parameter:param ResponseObject:^(NSDictionary *responseResult) {
...
- (void)getData{
    ...
    if (_keywords.length == 0) {
        ...
        param = @{@"type":@6, @"page":@1, @"keywords":_keywords};
    }
    [[SYHttpRequest sharedInstance] getDataWithUrl:url Parameter:param ResponseObject:^(NSDictionary *responseResult) {
...
- (void)getMoreData{
    ...
    NSDictionary *param = nil;
    if (_keywords.length == 0) {
        param = @{@"type":@6, @"page":[NSNumber numberWithInteger:self.page]};
    }else{
        param = @{@"type":@6, @"page":[NSNumber numberWithInteger:self.page], @"keywords":_keywords};
    }
    [[SYHttpRequest sharedInstance] getDataWithUrl:url Parameter:param ResponseObject:^(NSDictionary *responseResult) {
