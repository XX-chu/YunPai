...
@interface SYMyReciveGrapherViewController ()<UICollectionViewDelegate, UICollectionViewDataSource, UICollectionViewDelegateFlowLayout>
{
...
static NSString *grapherReciveIdentifier = @"grapherRecive";

@implementation SYMyReciveGrapherViewController
...
- (__kindof UICollectionViewCell *)collectionView:(UICollectionView *)collectionView cellForItemAtIndexPath:(NSIndexPath *)indexPath{
    SYUpdataMineCollectionViewCell *cell = [collectionView dequeueReusableCellWithReuseIdentifier:grapherReciveIdentifier forIndexPath:indexPath];
    if (!cell) {
...
- (UICollectionView *)collectionView{
    if (!_collectionView) {
        ...
        [_collectionView registerNib:[UINib nibWithNibName:@"SYUpdataMineCollectionViewCell" bundle:nil] forCellWithReuseIdentifier:grapherReciveIdentifier];
