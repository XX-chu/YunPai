...
@interface SYMyYuYueViewController ()<UIScrollViewDelegate>
{
...
@implementation SYMyYuYueViewController
...
//标签view
- (void)setLabelView{
    NSArray *titles = @[@"已完成", @"预约中", @"待拍摄", @"待评价"];
...
- (void)setChildViewControllers{
    SYMyYiWanChengViewController *all = [[SYMyYiWanChengViewController alloc] init];
    ...
    SYMyYuYueZhongViewController *fukuan = [[SYMyYuYueZhongViewController alloc] init];
    [self addChildViewController:fukuan];
    
    SYMyDaiPaiSheViewController *fahuo = [[SYMyDaiPaiSheViewController alloc] init];
    [self addChildViewController:fahuo];
    
    SYMyDaiPingJiaViewController *shouhuo = [[SYMyDaiPingJiaViewController alloc] init];
