...
#import "SYMyYiWanChengViewController.h"
...
@interface SYMyYiWanChengViewController ()<UITableViewDelegate, UITableViewDataSource>
{
    NSInteger _count;
}
...
@implementation SYMyYiWanChengViewController
...
- (void)tableView:(UITableView *)tableView didSelectRowAtIndexPath:(NSIndexPath *)indexPath{
    ...
    SYHaveCreatOrderInfosViewController *infos = [[SYHaveCreatOrderInfosViewController alloc] initWithOrderid:model.orderid OrderState:OrderStateYiWanCheng OrderModel:model];
...
- (UIView *)tableView:(UITableView *)tableView viewForFooterInSection:(NSInteger)section{
    ...
    [btn setTitle:@"再次预约" forState:UIControlStateNormal];
    ...
    btn.tag = section;
    [btn addTarget:self action:@selector(zaiciYuYue:) forControlEvents:UIControlEventTouchUpInside];
    
    UIButton *delBtn = [UIButton buttonWithType:UIButtonTypeCustom];
    [delBtn setTitle:@"删除" forState:UIControlStateNormal];
    [delBtn setTitleColor:HexRGB(0x999999) forState:UIControlStateNormal];
    delBtn.titleLabel.font = [UIFont systemFontOfSize:16];
    delBtn.frame = CGRectMake(kScreenWidth - 105 - 13 - 25 - 65, 10, 65, 30);
    delBtn.layer.cornerRadius = 5;
    delBtn.layer.borderColor = HexRGB(0x999999).CGColor;
    delBtn.layer.borderWidth = 1;
    delBtn.layer.masksToBounds = YES;
    [view1 addSubview:delBtn];
    delBtn.tag = section;
    [delBtn addTarget:self action:@selector(deleAction:) forControlEvents:UIControlEventTouchUpInside];
    return view;
}
