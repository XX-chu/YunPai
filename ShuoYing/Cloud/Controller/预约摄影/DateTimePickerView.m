...
- (instancetype)initWithFrame:(CGRect)frame{
    ...
    if (self) {
        ...
        UIView *contentV = [[UIView alloc] initWithFrame:CGRectMake(0, screenHeight-kNavigationBarHeightAndStatusBarHeight, screenWith, 220)];
...
- (void)showDateTimePickerView{
    [self setCurrentDate:[NSDate date]];
    self.frame = CGRectMake(0, 0, screenWith, screenHeight-kNavigationBarHeightAndStatusBarHeight);
    [UIView animateWithDuration:0.25f animations:^{
        self.alpha = 1;
        _contentV.frame = CGRectMake(0, screenHeight-kNavigationBarHeightAndStatusBarHeight-220, screenWith, 220);
