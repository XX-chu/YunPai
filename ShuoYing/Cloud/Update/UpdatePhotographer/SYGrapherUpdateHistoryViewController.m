...
- (void)loadCollectionView{
    ...
    self.collectionView = [[UICollectionView alloc] initWithFrame:CGRectMake(0, 0, kScreenWidth, kScreenHeight - kNavigationBarHeightAndStatusBarHeight - 80) collectionViewLayout:layout];
...
- (void)initBottomView{
    UIView *view = [[UIView alloc] initWithFrame:CGRectMake(0, kScreenHeight - 80 - kNavigationBarHeightAndStatusBarHeight, kScreenWidth, 80)];
    view.backgroundColor = [UIColor clearColor];
    _updateBottomView = view;
...
- (void)deleteAction:(UIButton *)sender{
    ...
    UIAlertAction *action = [UIAlertAction actionWithTitle:@"确定" style:UIAlertActionStyleDefault handler:^(UIAlertAction * _Nonnull action) {
        ...
        NSDictionary *param = @{@"token":UserToken, @"type":@"pho", @"id":[muArr componentsJoinedByString:@","]};
        NSLog(@"param - %@",param);
        [[SYHttpRequest sharedInstance] getDataWithUrl:url Parameter:param ResponseObject:^(NSDictionary *responseResult) {
