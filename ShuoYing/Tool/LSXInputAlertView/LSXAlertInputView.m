...
//    _textView.layer.borderWidth=0.5;
    ...
    qxbtn.layer.borderWidth = .5;
    qxbtn.layer.borderColor = HexRGB(0xeaeaea).CGColor;
    qxbtn.layer.masksToBounds = YES;
    ...
    [qxbtn setTitleColor:HexRGB(0x434343) forState:UIControlStateNormal];
    ...
    okbtn.layer.borderColor = HexRGB(0xeaeaea).CGColor;
    okbtn.layer.masksToBounds = YES;
    okbtn.backgroundColor=[UIColor whiteColor];
    [okbtn setTitle:@"确定" forState:UIControlStateNormal];
    [okbtn setTitleColor:HexRGB(0x3dcfbb) forState:UIControlStateNormal];
...
//    titLa.sd_layout.topSpaceToView(alertView,20).leftSpaceToView(alertView,0).heightIs(20).rightSpaceToView(alertView,0);
    ...
    _textView.sd_layout.topSpaceToView(alertView,15).leftSpaceToView(alertView,15).heightIs(noteTextHeight).rightSpaceToView(alertView,15);

    qxbtn.sd_layout.topSpaceToView(_textView,15).leftSpaceToView(alertView,0).heightIs(40).widthIs((SCREEN_WIDTH-80)/2);

    okbtn.sd_layout.topSpaceToView(_textView,15).leftSpaceToView(qxbtn,0).heightIs(40).rightSpaceToView(alertView,0);
