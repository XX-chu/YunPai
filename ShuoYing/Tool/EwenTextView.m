...
//        [self.sendButton setBackgroundColor:UIColorRGB(70 , 163, 231)];
    ...
    if (curheight < 19.094) {
        statusTextView = NO;
        self.backGroundView.frame = CGRectMake(0, y - selfHeight, kScreenwidth, selfHeight);
...
- (UIView *)backGroundView{
    if (!_backGroundView) {
        _backGroundView = [[UIView alloc]initWithFrame:CGRectMake(0, 0, kScreenwidth, selfHeight)];
        _backGroundView.backgroundColor = RGB(243, 243, 243);
...
- (UIView *)lineView{
    if (!_lineView) {
        ...
        _lineView.backgroundColor = RGB(228, 221, 221);
...
- (UILabel *)placeholderLabel{
    if (!_placeholderLabel) {
        ...
        _placeholderLabel.textColor = RGB(155, 155, 155);
...
- (UIButton *)sendButton{
    if (!_sendButton) {
        ...
        [_sendButton setImage:[UIImage imageNamed:@"comment_write_sent"] forState:UIControlStateNormal];
