...
- (void)setFl_badgeValue:(NSString *)fl_badgeValue{
    ...
    if (fl_badgeValue == nil || [fl_badgeValue isEqualToString:@""] || fl_badgeValue.integerValue <= 0) {
        ...
        CGRect rect = [fl_badgeValue  boundingRectWithSize:CGSizeMake(MAXFLOAT, MAXFLOAT) options:NSStringDrawingUsesLineFragmentOrigin attributes:@{NSFontAttributeName : [UIFont systemFontOfSize:11]} context:nil];
        // 带数字红点
        ...
        //不带数字红点
//        UIButton *redBtn = [[UIButton alloc] initWithFrame:CGRectMake(0, 0,  fl_badgeValue_height , fl_badgeValue_height)];
