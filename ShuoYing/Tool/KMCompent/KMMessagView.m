...
-(instancetype)initWithFrame:(CGRect)frame PlaceText:(NSString *)placeText PlaceColor:(UIColor *)placeColor{
    ...
    if (self) {
       ...
       [self addSubview:[self addUpline]];
        ...
        [_sendButton setBackgroundImage:[UIImage imageNamed:@"comment_write_sent"] forState:UIControlStateNormal];
...
-(void)TextViewDidChange:(CGSize)size{
    ...
    if (_Inputview.Textnil) {
        ...
        [_sendButton setBackgroundImage:[UIImage imageNamed:@"comment_write_sent_sel"] forState:UIControlStateNormal];
